    ...
    while c4.position != c4.correct_position or c6.position != c6.correct_position or c19.position != c19.correct_position or c13.position != c13.correct_position:       
        for x in range(6):
            if c4.position != c4.correct_position:
                if c4.position == vector(2,0,-1) or c4.position == vector(1,0,-2) or c4.position == vector(0,0,-1) or c4.position == vector(1,0,0):
            ...
            if c6.position != c6.correct_position:
                if c6.position == vector(2,0,-1) or c6.position == vector(1,0,-2) or c6.position == vector(0,0,-1) or c6.position == vector(1,0,0):
            ...
            if c19.position != c19.correct_position:
                if c19.position == vector(2,0,-1) or c19.position == vector(1,0,-2) or c19.position == vector(0,0,-1) or c19.position == vector(1,0,0):
            ...
            if c13.position != c13.correct_position:
                if c13.position == vector(2,0,-1) or c13.position == vector(1,0,-2) or c13.position == vector(0,0,-1) or c13.position == vector(1,0,0):
                    x = 0
    ...
    while c7.orientation1 != c7.correct_orientation1 or c9.orientation1 != c9.correct_orientation1 or c11.orientation1 != c11.correct_orientation1 or c17.orientation1 != c17.correct_orientation1:
        ...
        while c7.orientation1 != c7.correct_orientation1 or c9.orientation1 != c9.correct_orientation1 or c11.orientation1 != c11.correct_orientation1 or c17.orientation1 != c17.correct_orientation1:
            if c7.orientation1 != c7.correct_orientation1 and c9.orientation1 != c9.correct_orientation1 and c11.orientation1 != c11.correct_orientation1 and c17.orientation1 != c17.correct_orientation1:
                while c7.orientation1 != vector(1,0,0) and c9.orientation1 != vector(1,0,0) and c11.orientation1 != vector(1,0,0) and c17.orientation1 != vector(1,0,0):
                    down_rotation_clock()
                rururuur()
            if (c7.orientation1 == c7.correct_orientation1 and c9.orientation1 != c9.correct_orientation1 and c11.orientation1 != c11.correct_orientation1 and c17.orientation1 != c17.correct_orientation1) or (c7.orientation1 != c7.correct_orientation1 and c9.orientation1 == c9.correct_orientation1 and c11.orientation1 != c11.correct_orientation1 and c17.orientation1 != c17.correct_orientation1) or (c7.orientation1 != c7.correct_orientation1 and c9.orientation1 != c9.correct_orientation1 and c11.orientation1 == c11.correct_orientation1 and c17.orientation1 != c17.correct_orientation1) or (c7.orientation1 != c7.correct_orientation1 and c9.orientation1 != c9.correct_orientation1 and c11.orientation1 != c11.correct_orientation1 and c17.orientation1 == c17.correct_orientation1):
            ...
            if g == 2:
                for x in range(len(check_for_orient)):
                    if check_for_orient[x].orientation1 != check_for_orient[x].correct_orientation1:
                        debug = 0
                        while check_for_orient[x].position != vector(2,0,0) and check_for_orient[x].orientation1 != vector(0,0,1):
                            down_rotation_clock()
                            debug += 1
                            if debug ==4:
                                break
